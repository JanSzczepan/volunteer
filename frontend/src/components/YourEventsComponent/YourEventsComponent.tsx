      ...
      <section className={`section ${styles.yourEventsSection}`}>
         <div className={styles.outsideEventsContainer}>
            <div className={styles.eventsContainer}>
               <h2 className={styles.eventHeaderText}>
                  {isArchival ? 'Archiwalne wolontariaty, których' : 'Wolontariaty, których'} <br className={styles.eventBr} /> {isArchival ? 'byłeś' : 'jesteś'} autorem:
               </h2>
               {!isArchival && (
                  <>
            ...
            <div className={styles.eventsContainer}>
               <h2 className={styles.eventHeaderText}>
                  {isArchival ? 'Archiwalne wolontariaty' : 'Wolontariaty'}, w których <br className={styles.eventBr} /> {isArchival ? 'brałeś' : 'bierzesz'} udział:
               </h2>
               {!isArchival && (
                  <>
                     ...
                     {Boolean(!participantEvents?.length) && (
                        <div>
                           ...
                           <Link
                              ...
                              className={`${styles.addEventButton} ${styles.exploreButton}`}
                           >
                              Przeglądaj
                           </Link>
                        </div>
