...
const VOLUNTEER_REASONS_LIST = [
   { header: 'Doświadczenie i umiejętności' },
   { header: 'Możliwość poznania branży' },
   { header: 'Ciekawe znajomości' },
   { header: 'Nauka empatii i wdzięczności' },
   { header: 'Wpływ na świat wokół siebie' }
]
         ...
         <div className={styles.aboutContainer}>
            <div>
               ...
               {VOLUNTEER_REASONS_LIST.map((item, i) => (
                  <div className={styles.reasonContainer} key={i}>
            ...
            <img className={styles.image} src={Image} alt="Wolontariusze" />
         </div>
      </section>
   )
}
