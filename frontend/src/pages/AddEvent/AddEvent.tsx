      ...
      <section className={`section ${styles.section}`}>
         ...
         >
            ...
            <input
               ...
               className={`addEventInput ${error?.emptyFields?.includes('title') && styles.inputError}`}
               id='title'
               type='text'
            />
            <label
            ...
            <div className={styles.inputsContainer}>
               <div>
                  <label
                     className={`addEventLabel ${styles.addEventLabel}`}
                     htmlFor='city'
                  >
                     Miasto
                  </label>
                  <input
                     ...
                     className={`addEventInput ${error?.emptyFields?.includes('city') && styles.inputError}`}
                     id='city'
                     type='text'
                  />
               </div>
            ...
            <select
               ...
               className={`addEventSelect ${error?.emptyFields?.includes('cathegory') && styles.inputError}`}
               id='cathegory'
            >
            ...
            <input
               ...
               className={`addEventDateTime ${error?.emptyFields?.includes('date') && styles.inputError}`}
               type='datetime-local'
               id='datetime'
            />
