        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, this.findOne({ $or: [{ name: login }, { email: login }] })];
                case 1:
                    user = _a.sent();
                    if (!user)
...
userSchema.statics.signup = function (name, email, password) {
    return __awaiter(this, void 0, void 0, function () {
        var nameExists, emailExists, salt, hash, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 4:
                    hash = _a.sent();
                    return [4 /*yield*/, this.create({ name: name, email: email, password: hash })];
                case 5:
                    user = _a.sent();
                    return [2 /*return*/, user];
            }
